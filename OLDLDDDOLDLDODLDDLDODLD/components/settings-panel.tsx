...
import { X, Users, CreditCard, SettingsIcon } from "lucide-react"
...
export function SettingsPanel({ view, onClose, onViewChange }: SettingsPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-6xl h-[80vh] flex overflow-hidden">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-1">
                <button
                  className={`w-full text-left px-3 py-2 rounded-md ${activeTab === "user" && activeTab === "user" ? "bg-blue-50 text-blue-600" : "text-gray-700 hover:bg-gray-100"}`}
