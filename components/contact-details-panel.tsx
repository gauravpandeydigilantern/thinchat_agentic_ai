...
import { X, MapPin, Edit, Download, Trash2, Linkedin, Twitter, Facebook, Search } from "lucide-react"
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${contact.companyEmail}`} className="font-medium text-blue-600 hover:underline">
